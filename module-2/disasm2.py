...
# has rm
# use reg
# displacement size (0 = none)
# immediate size (0 = none)
...
ONEB_GLOBAL_OPCODE_LIST = {
    ...
    0x81 : [0x81, "add", "mi", True],
    0x89 : [0x89, "mov", "mr", True],
    0x8b : [0x8b, "mov", "rm", True],
    0xb8 : [0xb8, "mov", "oi", False],
    0xc2 : [0xc2, "retn", "oi", False],
    0x33 : [0x33, "xor", "rm", True]
}
